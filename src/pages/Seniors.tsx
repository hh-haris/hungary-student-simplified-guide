  ...
  return (
    <div className="min-h-screen flex flex-col bg-off-white">
      ...
      <main className="flex-grow container mx-auto px-4 py-6 md:py-10">
        <h1 className="font-syne font-bold text-3xl mb-6">Seniors Section</h1>
                  ...
                  <div className="p-5 flex space-x-4">
                    <div className="w-20 h-20 rounded-full bg-gray-200 flex-shrink-0 overflow-hidden">
                      {senior.picture ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center text-gray-400">No DP</div>
                      )}
                    </div>
                    <div>
                  ...
                  <div className="p-5 border-t border-gray-100">
                    ...
                    {senior.isAdmin && (
                      <div className="mb-4">
                        ...
                        <p className="text-sm">{senior.adminStory}</p>
                      </div>
                    )}
