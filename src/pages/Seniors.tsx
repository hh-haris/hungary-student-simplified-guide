...
const Seniors = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-off-white">
      <Header />
      <main className="flex-grow container mx-auto px-4 py-6 md:py-10 md:px-8 lg:px-12">
        <h1 className="font-syne font-bold text-3xl mb-6 text-deep-teal text-center md:text-left">Seniors Section</h1>
        
        <div className="bg-white rounded-lg shadow-sm p-5 mb-8 md:p-6 lg:p-8">
          ...
          <div className="grid gap-4 md:grid-cols-3 mb-6">
            ...
            <div>
              ...
              <Select onValueChange={setSelectedProgram} defaultValue={selectedProgram} className="w-full">
                <SelectTrigger>
            ...
            <div>
              ...
              <Select onValueChange={setSelectedUniversity} defaultValue={selectedUniversity} className="w-full">
                <SelectTrigger>
        ...
        {adminSeniors.length > 0 && (
          <div className="mb-10">
            <h2 className="font-syne font-bold text-2xl mb-4 text-deep-teal flex items-center">
              <Award className="h-6 w-6 mr-2 text-accent-orange" /> Community Admins
            </h2>
                    ...
                    <div className="flex flex-col">
                      <div className="bg-gradient-to-r from-deep-teal/10 to-accent-orange/10 p-5 border-b border-gray-100">
                        <div className="flex space-x-4">
                          ...
                          <div>
                            <h2 className="font-syne font-bold text-lg">{admin.name}</h2>
                            <p className="text-light-teal text-sm">{admin.program}</p>
                            <p className="text-sm text-gray-600">{admin.university}</p>
                            <div className="flex flex-wrap gap-2 mt-2">
                              <Badge variant="outline" className="bg-blue-100 text-blue-800 text-xs">
                                {admin.currentYear}
                              </Badge>
                              <Badge variant="outline" className="bg-accent-orange/10 text-accent-orange text-xs">
                                Admin
                              </Badge>
                              <Badge variant="outline" className={admin.inHungary ? "bg-green-100 text-green-800 text-xs" : "bg-yellow-100 text-yellow-800 text-xs"}>
                        ...
                        <div className="mb-4">
                          ...
                          <div className="flex items-center">
                            ...
                            {admin.timesApplied > 1 && (
                              <Badge className="ml-2 bg-yellow-100 text-yellow-800 text-xs">Persistent</Badge>
                            )}
                          </div>
                        </div>
        ...
        <div>
          <h2 className="font-syne font-bold text-2xl mb-4 text-deep-teal flex items-center">
            <Users className="h-6 w-6 mr-2 text-accent-orange" /> Our Seniors in Hungary
          </h2>
                  ...
                  <div className="flex flex-col">
                    <div className="p-5 border-b border-gray-100">
                      <div className="flex space-x-4">
                        ...
                        <div>
                          <h2 className="font-syne font-bold text-lg">{senior.name}</h2>
                          <p className="text-light-teal text-sm">{senior.program}</p>
                    ...
                    <div className="p-5">
                      ...
                      <div class="mb-4">
                        <p class="text-xs text-gray-500">Challenges Faced</p>
                        <p class="text-sm">{senior.challenges}</p>
                      </div>
                      
                      <div class="mb-4">
                        <p class="text-xs text-gray-500">Advice</p>
                        <p class="text-sm">{senior.advice}</p>
                      </div>
                      
                      <div class="flex flex-wrap gap-3 mt-4">
                        {senior.email && (
                          <a href={`mailto:${senior.email}`} class="flex items-center text-sm text-blue-600 hover:underline">
                            <Mail size={14} class="mr-1" /> Email
                          </a>
                        )}
                        
                        {senior.whatsapp && (
                          <a href={`https://wa.me/${senior.whatsapp}`} target="_blank" rel="noopener noreferrer" class="flex items-center text-sm text-green-600 hover:underline">
                            <MessageSquare size={14} class="mr-1" /> WhatsApp
                          </a>
                        )}
          ...
          {regularSeniors.length === 0 && (
            <div class="bg-white rounded-lg shadow-sm p-5 text-center">
              <p class="text-gray-700">No seniors found matching your criteria.</p>
            </div>
          )}
        </div>
        ...
        <div class="mt-16 border-t border-gray-200 pt-8">
          <div class="backdrop-blur-sm bg-white/40 rounded-lg p-6 border border-gray-100 max-w-3xl mx-auto">
            <div class="flex items-center justify-center mb-4">
              <Heart class="h-5 w-5 text-accent-orange mr-2" /> Meet the Creator
            </div>
