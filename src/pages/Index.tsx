...
const Index = () => {
  const timelineSteps = [{
    ...
    description: "If you are nominated by HEC in February 2026, begin the next steps by getting your documents attested and completing the required medical examination.",
    linkTo: "/documents",
